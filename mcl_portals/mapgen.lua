...
minetest.register_alias("mapgen_apple", "mcl_core:apple")
...
minetest.register_alias("mapgen_pine_tree", "mcl_core:pine_tree")
minetest.register_alias("mapgen_pine_needles", "mcl_core:pine_needles")
...
minetest.register_alias("mapgen_sandstonebrick", "mcl_core:sandstonebrick")
minetest.register_alias("mapgen_stair_sandstonebrick", "stairs:stair_sandstonebrick")

--maikerumine
minetest.register_alias("mcl_core:stone_with_copper", "mcl_core:stone_with_iron")
minetest.register_alias("mcl_core:bedrock", "mcl_core:bedrock")
...
minetest.register_ore({
	...
	wherein        = {"mcl_core:water_source","mcl_core:lava_source","mcl_core:rack", "air"},
