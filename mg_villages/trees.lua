...
local c_tree = minetest.get_content_id("mcl_core:tree")
local c_leaves = minetest.get_content_id("mcl_core:leaves")
local c_sapling = minetest.get_content_id("mcl_core:sapling");
local c_junglesapling = minetest.get_content_id("mcl_core:junglesapling");
local c_snow = minetest.get_content_id("mcl_core:snow");
local c_msnow_top = minetest.get_content_id( 'moresnow:snow_top' );

local c_msnow_leaves1 = minetest.get_content_id( 'mcl_core:leaves' );
local c_msnow_leaves2 = minetest.get_content_id( 'mcl_core:leaves' );
