...
if(	    minetest.get_modpath( 'trees' )
	...
	mg_villages.realtest_stairs = {'mcl_core:stone','mcl_core:stone_flat','mcl_core:stone_bricks',
	                               'mcl_core:desert_stone_flat','mcl_core:desert_stone_bricks'};
...
mg_villages.replace_materials = function( replacements, pr, original_materials, prefixes, materials, old_material )
	...
	if( mg_villages.realtest_trees 
		and #prefixes==3
		and prefixes[1]=='stairs:stair_' and prefixes[2]=='stairs:slab_' and prefixes[3]=='mcl_core:' ) then 
...
--[[
	-- deco is used by BigFreakingDig; as that one lacks mcl_core nodes, it doesn't work out here
...
mg_villages.replace_tree_trunk = function( replacements, wood_type )
	if(     wood_type == 'mcl_core:junglewood' ) then
		table.insert( replacements, {'mcl_core:tree',  'mcl_core:jungletree'});
	elseif( wood_type == 'mcl_core:pine_wood' ) then
		table.insert( replacements, {'mcl_core:tree',  'mcl_core:pine_tree'});
	elseif( wood_type == 'mcl_core:acacia_wood' ) then
		table.insert( replacements, {'mcl_core:tree',  'mcl_core:acacia_tree'});
	elseif( wood_type == 'mcl_core:aspen_wood' ) then
		table.insert( replacements, {'mcl_core:tree',  'mcl_core:aspen_tree'});
	elseif( wood_type == 'mg:savannawood' ) then
		table.insert( replacements, {'mcl_core:tree',  'mg:savannatree'});
	elseif( wood_type == 'mg:pinewood' ) then
		table.insert( replacements, {'mcl_core:tree',  'mg:pinetree'});

 	elseif( mg_villages.moretrees_treelist ) then
		for _,v in ipairs( mg_villages.moretrees_treelist ) do
			if( wood_type == "moretrees:"..v[1].."_planks" ) then
				table.insert( replacements, {'mcl_core:tree',   "moretrees:"..v[1].."_trunk"});
				table.insert( replacements, {'mcl_core:leaves', "moretrees:"..v[1].."_leaves"});
			end
		end

	elseif( wood_type == 'deco:birch_plank' ) then
		table.insert( replacements, {'mcl_core:tree', "mapgen:birch_log"});
	elseif( wood_type == 'deco:cherry_plank' ) then
		table.insert( replacements, {'mcl_core:tree', "mapgen:cherry_log"});
	elseif( wood_type == 'deco:evergreen_plank' ) then
		table.insert( replacements, {'mcl_core:tree', "mapgen:evergreen_log"});
	elseif( wood_type == 'deco:oak_plank' ) then
		table.insert( replacements, {'mcl_core:tree', "mapgen:oak_log"});

	elseif( wood_type == 'ethereal:frost_wood' ) then
		table.insert( replacements, {'mcl_core:tree', "ethereal:frost_tree"});

	elseif( wood_type == "ethereal:mushroom_pore" ) then
		table.insert( replacements, {'mcl_core:tree', "ethereal:mushroom_trunk"});

	elseif( mg_villages.ethereal_trees ) then
		for _,v in ipairs( mg_villages.ethereal_trees ) do
			if( wood_type == "ethereal:"..v.."_wood" ) then
				table.insert( replacements, {'mcl_core:tree', "ethereal:"..v.."_trunk"});
			end
		end
	...
	elseif( mg_villages.forest_trees ) then
		for _,v in ipairs( mg_villages.forest_trees ) do
			if( wood_type == "forest:"..v.."_wood" ) then
				table.insert( replacements, {'mcl_core:tree', "forest:"..v.."_tree"});
			end
		end
	...
	elseif( mg_villages.tinytrees_trees ) then
		for _,v in ipairs( mg_villages.tinytrees_trees ) do
			if( wood_type == "trees:wood_"..v ) then
				table.insert( replacements, {'mcl_core:tree', "trees:tree_"..v});
			end
		end
	...
	elseif( mg_villages.realtest_trees ) then
		for _,v in ipairs( mg_villages.realtest_trees ) do
			if( wood_type == 'trees:'..v..'_planks' ) then
				table.insert( replacements, {'mcl_core:tree', "trees:"..v..'_log'});
				-- realtest does not have most of the nodes from mcl_core, so we need to replace them as well
				table.insert( replacements, {'mcl_core:wood',         'trees:'..v..'_planks'});
				table.insert( replacements, {'mcl_core:leaves',       'trees:'..v..'_leaves'});
				table.insert( replacements, {'mcl_core:ladder',       'trees:'..v..'_ladder'});
				table.insert( replacements, {'mcl_core:chest',        'trees:'..v..'_chest'});
				table.insert( replacements, {'mcl_core:chest_locked', 'trees:'..v..'_chest_locked'});
				table.insert( replacements, {'mcl_core:fence_wood',   'fences:'..v..'_fence'});
				table.insert( replacements, {'mcl_core:bookshelf',    'decorations:bookshelf_'..v});
				...
				table.insert( replacements, {'mcl_core:furnace',      'oven:oven'});
				...
				-- stairs and slabs made out of mcl_core wood
...
mg_villages.replace_saplings = function( replacements, wood_type )
	...
	elseif( wood_type == 'mcl_core:pine_wood' ) then
		table.insert( replacements, {'mcl_core:sapling',  'mcl_core:pine_sapling'});
	elseif( wood_type == 'mcl_core:acacia_wood' ) then
		table.insert( replacements, {'mcl_core:sapling',  'mcl_core:acacia_sapling'});
	elseif( wood_type == 'mcl_core:aspen_wood' ) then
		table.insert( replacements, {'mcl_core:sapling',  'mcl_core:aspen_sapling'});
	elseif( wood_type == 'mg:savannawood' ) then
		table.insert( replacements, {'mcl_core:sapling',  'mg:savannasapling'});
	elseif( wood_type == 'mg:pinewood' ) then
		table.insert( replacements, {'mcl_core:sapling',  'mg:pinesapling'});
 	elseif( mg_villages.moretrees_treelist ) then
		for _,v in ipairs( mg_villages.moretrees_treelist ) do
			if( wood_type == "moretrees:"..v[1].."_planks" ) then
 	...
 	elseif( mg_villages.realtest_trees ) then
		for _,v in ipairs( mg_villages.realtest_trees ) do
			if( wood_type == 'trees:'..v..'_planks' ) then
				...
				table.insert( replacements, {'mcl_core:pine_sapling',  "trees:"..v.."_sapling"});
				table.insert( replacements, {'mcl_core:aspen_sapling', "trees:"..v.."_sapling"});
			end
		end
...
--   table.insert( replacements, {'mcl_core:dirt',            dirt_with_grass_replacement });
--   table.insert( replacements, {'mcl_core:dirt_with_grass', dirt_with_grass_replacement });
   table.insert( replacements, {'mcl_core:dirt',            'mcl_core:dirt_with_grass' });

   -- realtest lacks quite a lot from mcl_core
   if( mg_villages.realtest_trees ) then
	...
	for i=1,5 do
  	...
  	table.insert(         replacements, {'mcl_core:apple',           'air' });
  	table.insert(         replacements, {'mcl_core:cobble',          'mcl_core:stone_macadam' });
  	table.insert(         replacements, {'mcl_core:obsidian_glass',  'mcl_core:glass' });

   -- the mcl_core doors from minetest game have been changed since the schematics where built
...
mg_villages.replacements_taoki = function( housetype, pr, replacements )
      ...
      if( mg_villages.realtest_trees ) then
		...
		{'mcl_core:wood'},
 		'mcl_core:wood');
         table.insert( replacements, {'stairs:stair_cobble', 'mcl_core:stone_bricks_stair' }); 
         table.insert( replacements, {'stairs:slab_cobble',  'mcl_core:stone_bricks_slab' }); 
         table.insert( replacements, {'stairs:stair_stone',  'mcl_core:stone_flat_stair' }); 
         table.insert( replacements, {'stairs:slab_stone',   'mcl_core:stone_flat_slab' }); 
      else    
      -- the main body of the houses in the .mts files is made out of wood
         wood_type = mg_villages.replace_materials( replacements, pr,
		{'mcl_core:wood'},
		{''},
		{'mcl_core:wood', 'mcl_core:junglewood', 'mcl_core:pine_wood', 'mcl_core:acacia_wood', 'mcl_core:aspen_wood', 'mg:pinewood', 'mg:savannawood',
		'mcl_core:clay', 'mcl_core:brick', 'mcl_core:sandstone', 
		'mcl_core:stonebrick', 'mcl_core:desert_stonebrick','mcl_core:sandstonebrick', 'mcl_core:sandstone','mcl_core:stone','mcl_core:desert_stone',
		...
		--'mcl_core:coalblock','mcl_core:steelblock','mcl_core:goldblock', 'mcl_core:bronzeblock', 'mcl_core:copperblock', 'wool:white',
		'mcl_core:stone_flat', 'mcl_core:desert_stone_flat', -- realtest
      ...
      mg_villages.replace_materials( replacements, pr,
		{'stairs:stair_stonebrick',  'stairs:slab_stonebrick', 'mcl_core:stonebrick'},
		{'stairs:stair_',            'stairs:slab_',           'mcl_core:'          },
      ...
      mg_villages.replace_materials( replacements, pr,
		{'stairs:stair_brick',  'stairs:slab_brick', 'mcl_core:brick'},
		{'stairs:stair_',       'stairs:slab_',      'mcl_core:'     },
...
--		{'mcl_core:'},
		{'stairs:stair_stonebrick',  'stairs:slab_stonebrick', 'mcl_core:stonebrick'},
		{'stairs:stair_',       'stairs:slab_',      'mcl_core:'     },
		{'stonebrick', 'desert_stonebrick','sandstonebrick', 'sandstone','stone','desert_stone','stone_flat','desert_stone_flat','stone_bricks','desert_stone_bricks', "mcl_core:obsidianbrick"},
		'stonebrick');
      ...
      local wood_type = mg_villages.replace_materials( replacements, pr,
		{'mcl_core:wood'},
		{''},
		{ 'mcl_core:wood', 'mcl_core:junglewood', 'mcl_core:pine_wood', 'mcl_core:acacia_wood', 'mcl_core:aspen_wood', 'mg:savannawood', 'mg:pinewood' },
		'mcl_core:wood');
      mg_villages.replace_tree_trunk( replacements, wood_type );
      mg_villages.replace_saplings(   replacements, wood_type );

      if( pr:next(1,3)==1 and not( mg_villages.realtest_trees)) then
         table.insert( replacements, {'mcl_core:glass', 'mcl_core:obsidian_glass'});
      end
...
mg_villages.replacements_lumberjack = function( housetype, pr, replacements )
      ...
      if( not( minetest.get_modpath('bell' ))) then
         table.insert( replacements, {'bell:bell',               'mcl_core:goldblock' });
      end
      if( mg_villages.realtest_trees ) then
         table.insert( replacements, {'stairs:stair_cobble', 'mcl_core:stone_bricks_stair' }); 
         table.insert( replacements, {'stairs:slab_cobble',  'mcl_core:stone_bricks_slab' }); 
...
mg_villages.replacements_logcabin = function( housetype, pr, replacements )
      ...
      if( mg_villages.realtest_trees ) then
		...
		'mcl_core:wood');
         mg_villages.replace_tree_trunk( replacements, wood_type );
         mg_villages.replace_saplings(   replacements, wood_type );
         table.insert( replacements, {'mcl_core:stonebrick',      'mcl_core:stone_bricks' }); -- used for chimneys
         table.insert( replacements, {'stairs:stair_stonebrick', 'mcl_core:stone_bricks_stair' }); 
         -- table.insert( replacements, {'mcl_core:junglewood', wood_type }); -- replace the floor
...
mg_villages.replacements_chateau = function( housetype, pr, replacements )
      ...
      if( minetest.get_modpath( 'cottages' )) then
		...
		'stonebrick');
         table.insert( replacements, { 'cottages:glass_pane', 'mcl_core:glass' });
      end
      ...
      local wood_type = mg_villages.replace_materials( replacements, pr,
		{'mcl_core:wood'},
		{''},
		{ 'mcl_core:wood', 'mcl_core:junglewood', 'mcl_core:pine_wood', 'mcl_core:acacia_wood', 'mcl_core:aspen_wood', 'mg:savannawood', 'mg:pinewood'}, --, 'mcl_core:brick', 'mcl_core:sandstone', 'mcl_core:desert_cobble' },
		'mcl_core:wood');
      mg_villages.replace_tree_trunk( replacements, wood_type );
      mg_villages.replace_saplings(   replacements, wood_type );
      ...
      if( mg_villages.realtest_trees ) then
         -- replace the floor with another type of wood (looks better than the same type as above)
         mg_villages.replace_materials( replacements, pr,
		{'stairs:stair_junglewood',  'stairs:slab_junglewood', 'mcl_core:junglewood'},
		{'stairs:stair_',            'stairs:slab_',           'mcl_core:'     },
		{ 'mcl_core:wood' },
		'wood' );
      end
      ...
      local mfs2 = mg_villages.replace_materials( replacements, pr,
		{'stairs:stair_cobble',  'stairs:slab_cobble', 'mcl_core:cobble'},
		{'stairs:stair_',        'stairs:slab_',       'mcl_core:'      },
		{ 'cobble', 'brick', 'clay', 'desert_cobble', 'desert_stone', 'desert_stonebrick', 'sandstone', 'sandstonebrick', 'stonebrick', "mcl_core:obsidianbrick" },
		'cobble');
...
mg_villages.replacements_tent = function( housetype, pr, replacements )
      ...
      table.insert( replacements, { "mcl_core:gravel",        "mcl_core:sand"       });
...
mg_villages.replacements_grasshut = function( housetype, pr, replacements )
      table.insert( replacements, {'moreblocks:fence_jungle_wood',     'mcl_core:fence' });
      ...
      if( pr:next( 1, 4) == 1 ) then
         table.insert( replacements, {'dryplants:wetreed_roof_corner',    'mcl_core:wood' });
         table.insert( replacements, {'dryplants:wetreed_roof_corner_2',  'mcl_core:junglewood' });
      end
      if( not( minetest.get_modpath( 'cavestuff' ))) then
         table.insert( replacements, {'cavestuff:desert_pebble_2',        'mcl_core:slab_cobble' });
      end
   
      table.insert( replacements, {'mcl_core:desert_sand', 'mcl_core:dirt_with_grass' });
      return replacements;
end
...
mg_villages.replacements_claytrader = function( housetype, pr, replacements )
      ...
      mg_villages.replace_materials( replacements, pr,
		{ 'stairs:stair_brick', 'stairs:slab_brick', 'mcl_core:brick' }, -- mcl_core_materials
		{ 'stairs:stair_',      'stairs:slab_',      'mcl_core:'      }, -- prefixes (for new materials)
      ...
      if( mg_villages.realtest_trees ) then
		...
		'mcl_core:wood');
         mg_villages.replace_tree_trunk( replacements, wood_type );
         mg_villages.replace_saplings(   replacements, wood_type );
         table.insert( replacements, {'mcl_core:clay', 'mcl_core:dirt_with_clay'});
         local mfs2 = mg_villages.replace_materials( replacements, pr,
		{'stairs:stair_cobble',  'stairs:slab_cobble', 'mcl_core:cobble'},
		{'stairs:stair_',        'stairs:slab_',       'mcl_core:'      },
...
mg_villages.replacements_medieval = function( housetype, pr, replacements )
   ...
   table.insert( replacements, {'mcl_core:glass',           'air'});
...
--      table.insert( replacements, {'cottages:glass_pane',    'mcl_core:fence_wood'});
      local gp = mg_villages.replace_materials( replacements, pr,
	{'cottages:glass_pane'},
	{''},
	{'xpanes:pane', 'mcl_core:glass', 'mcl_core:obsidian_glass', 'mcl_core:fence_wood',
   ...
   local materials = {'cottages:loam', 'cottages:loam', 'cottages:loam', 'cottages:loam', 'cottages:loam', 
                      'mcl_core:clay',  'mcl_core:clay',  'mcl_core:clay',  'mcl_core:clay',  'mcl_core:clay',
                      'mcl_core:wood','mcl_core:junglewood', 'mcl_core:pine_wood', 'mcl_core:acacia_wood', 'mcl_core:aspen_wood', 'mcl_core:sandstone',
                      'mcl_core:desert_stone','mcl_core:brick','mcl_core:cobble','mcl_core:stonebrick',
                      'mcl_core:desert_stonebrick','mcl_core:sandstonebrick','mcl_core:stone',
   ...
   local mfs = mg_villages.replace_materials( replacements, pr,
	...
	'mcl_core:sandstone');
   if( mg_villages.realtest_trees ) then
       table.insert( replacements, {'stairs:slab_sandstone',   'mcl_core:stone_slab'});
       local mfs2 = mg_villages.replace_materials( replacements, pr,
		{'stairs:stair_sandstone',  'stairs:slab_sandstone', 'mcl_core:sandstone'},
		{'stairs:stair_',           'stairs:slab_',          'mcl_core:'         },
		{ 'stone' }, -- will be replaced by mg_villages.realtest_stairs
		'sandstone');
   elseif( mfs and mfs ~= 'mcl_core:sandstone' ) then

      if( mfs == 'cottages:loam' or mfs == 'mcl_core:clay' or mfs == 'mg:savannawood' or mfs == 'mg:pinewood') then
         mfs = 'mcl_core:wood';
      elseif( mfs =='mcl_core:sandstonebrick' or mfs == 'mcl_core:desert_stone' or mfs == 'mcl_core:desert_stonebrick'
   ...
   table.insert( materials, 'mcl_core:glass' );
   ...
   local replace_clay = mg_villages.replace_materials( replacements, pr,
	...
	materials,
	'mcl_core:clay');
   if( replace_clay and replace_clay ~= 'mcl_core:clay' ) then
   ...
   local mcs = mg_villages.replace_materials( replacements, pr,
		...
		'cobble');
   -- set a fitting material for the slabs; mossycobble uses the mcl_core cobble slabs
   if( mg_villages.realtest_trees ) then
      local mcs2 = mg_villages.replace_materials( replacements, pr,
		...
		{ 'stone' }, -- will be replaced by mg_villages.realtest_stairs
		'cobble');
      table.insert( replacements, {'moreblocks:slab_cobble',   'mcl_core:'..mcs..'_slab'});
...
mg_villages.replacements_tower = function( housetype, pr, replacements )
      ...
      local wood_type = mg_villages.replace_materials( replacements, pr,
                {'mcl_core:wood'},
                {''},
                { 'mcl_core:wood', 'mcl_core:junglewood', 'mg:savannawood', 'mg:pinewood' },
                'mcl_core:wood');
      mg_villages.replace_tree_trunk( replacements, wood_type );
      mg_villages.replace_saplings(   replacements, wood_type );
...
mg_villages.get_replacement_table = function( housetype, pr, replacements )
	...
	if( mg_villages.USE_mcl_core_3D_TORCHES == false ) then
		table.insert( replacements, {'mcl_core:torch', 'mg_villages:torch'});
	end

	-- make charachoal villages safe from spreading fire
	if( not( mg_villages.use_normal_unsafe_lava )) then
		table.insert( replacements, {'mcl_core:lava_source',  'mg_villages:lava_source_tamed'});
		table.insert( replacements, {'mcl_core:lava_flowing', 'mg_villages:lava_flowing_tamed'});
	end
