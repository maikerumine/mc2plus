...
minetest.register_craftitem("simple_banners:mcl_dye", {
	description = "ANY mcl_dye",
	inventory_image = "mcl_dye_grey.png",
...
minetest.register_craft({
	...
	recipe = {
			{"simple_banners:plain", "simple_banners:mcl_dye", ""},
			{"",  "simple_banners:mcl_dye", ""},
			{ "simple_banners:mcl_dye", "simple_banners:mcl_dye", "simple_banners:mcl_dye"},
	}
})
minetest.register_craft({
...
minetest.register_craft({
	...
	recipe = {
			{"simple_banners:mcl_dye","simple_banners:plain", "simple_banners:mcl_dye"},
			{"","simple_banners:mcl_dye",""},
			{"simple_banners:mcl_dye", "","simple_banners:mcl_dye"},
	}
})
...
minetest.register_craft({
	...
	recipe = {
			{"simple_banners:mcl_dye","simple_banners:plain",""},
			{"simple_banners:mcl_dye","simple_banners:mcl_dye",""},
			{"simple_banners:mcl_dye","simple_banners:mcl_dye","simple_banners:mcl_dye"},
	}
})
...
minetest.register_craft({
	...
	type = "shapeless",
	recipe = {
			  "simple_banners:plain",  "mcl_dye:" .. clrs[i][1] ,
	}
})
]]
...
minetest.register_node("simple_banners:cross_top_" .. clrs[i][1], {
	description = clrs[i][2] .. " Cross Top Pattern",
		drawtype = "nodebox",
	--tiles = {"mcl_wool_white.png^(mcl_core_apple.png)^[colorize:" .. clrs[i][3]},
	--tiles = {"mcl_wool_white.png^banners_cross.png^[makealpha:255,255,255^[colorize:" .. clrs[i][3]},
...
minetest.register_craft({
	...
	recipe = {
			{"simple_banners:plain", "mcl_dye:" .. clrs[i][1], ""},
			{"",  "mcl_dye:" .. clrs[i][1], ""},
			{ "mcl_dye:" .. clrs[i][1], "mcl_dye:" .. clrs[i][1], "mcl_dye:" .. clrs[i][1]},
	}
})
minetest.register_craft({
	output = "simple_banners:cross_top_".. clrs[i][1] .. " 1",
...
minetest.register_craft({
	...
	recipe = {
			{"mcl_dye:" .. clrs[i][1],"simple_banners:plain", "mcl_dye:" .. clrs[i][1]},
			{"","mcl_dye:" .. clrs[i][1],""},
			{"mcl_dye:" .. clrs[i][1], "","mcl_dye:" .. clrs[i][1]},
	}
})
minetest.register_craft({
	output = "simple_banners:x_top_".. clrs[i][1] .. " 1",
...
minetest.register_craft({
	...
	recipe = {
			{"mcl_dye:" .. clrs[i][1],"simple_banners:plain",""},
			{"mcl_dye:" .. clrs[i][1],"mcl_dye:" .. clrs[i][1],""},
			{"mcl_dye:" .. clrs[i][1],"mcl_dye:" .. clrs[i][1],"mcl_dye:" .. clrs[i][1]},
	}
})
...
--NOMAD BANNER -maikerumine-
	...
	minetest.register_craft({
		...
		recipe = {
			{"mcl_wool:white", "mcl_core:diamond", "mcl_wool:white"},
			{"mcl_wool:white", "mcl_wool:red", "mcl_wool:white"},
			{"mcl_wool:white", "group:stick", "mcl_wool:white"},
		}
	})
	minetest.register_craft({
		output = "simple_banners:nomad_top",
...
--VETERAN BANNER
	...
	minetest.register_craft({
		...
		recipe = {
			{"mcl_wool:white", "mcl_core:diamond", "mcl_wool:white"},
			{"mcl_wool:white", "mcl_wool:black", "mcl_wool:white"},
			{"mcl_wool:white", "group:stick", "mcl_wool:white"},
		}
	})
	minetest.register_craft({
